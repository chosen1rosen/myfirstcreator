    ...
    function renderBlockForm(b, i) {
      ...
      switch(b.type) {
        ...
        case 'email_capture': return f('title','Title') + f('subtitle','Subtitle') + f('cta_text','Button Text') + ctaDest(b, i) + f('label','Section Label (optional)') + chk('show_name','Show name field') + f('name_placeholder','Name Placeholder','text') + f('email_placeholder','Email Placeholder','text') + f('bg_color','Background Color','text','placeholder="transparent"');
